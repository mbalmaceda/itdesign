	...
	<footer>
		<div class="container">
			<div class="row">
				...
				<div class="span3">
					<div class="widget">
						<h5 class="widgetheading">Latest tweet</h5>
					<div class="twitter">
					</div>
					</div>	
				</div>
		...
		<div id="sub-footer">
			<div class="container">
				<div class="row">
					<div class="span6">
					<div class="copyright">
						<p><span>&copy;2013 Eterna company. All right reserved</span></p>
					</div>
					
					</div>
					
					<div class="span6">					
						<p class="credit">Designed by <a href="http://iweb-studio.com" target="_blank">iwebstudio</a></p>
					</div>	
				</div>
			</div>
		</div>			
